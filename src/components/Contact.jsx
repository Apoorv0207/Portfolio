...
const Contact = () => {
  return (
    <section id="contact" className="mb-16">
      ...
      <p className="mb-2"><strong>Phone:</strong> 9650698099</p>
      ...
      <p className="mb-2"><strong>Resume:</strong> <a href="https://drive.google.com/file/d/1Y83vza3zbcghd9nL5LGkcgkdA_zO9kUD/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="underline">Download</a></p>
    </section>
  );
};
